...
var FCGrid$ = function () {
      ...
      if(saveCodVideoGrid == ""){
        for(var i=0;i<=FC_MaxImages;i++)
        {
          if(i===0)
          {
            ...
            sHtmlZoom+="<div data-slide-id='zoom' class='zoom-gallery-slide active'><a href="+imgAmpMini+" class='MagicZoom' id='zoom2' data-mobile-options='textClickZoomHint: ' data-options='hint:off;selectorTrigger:hover;transitionEffect:false;'><img width='512' height='543' src="+ imgDetMini +" alt=\""+ fn.getNameProduct() +"\" "+ sLazy +"></a></div>"
                      +"<div class='selectors position-thumbnails'><a href=\""+imgAmpMini+"\" data-slide-id='zoom'  data-zoom-id='zoom2' class='active' data-image=\""+ imgDetMini +"\"><img width='66' height='70' src=\""+ imgDetMini +"\" class=ZoomIMG2 alt=\""+ fn.getNameProduct() +"\" "+ sLazy +"></a>"
          }
          else{
            ...
            sHtmlZoom+="<div class='selectors'><a href="+imgAmpMini+" data-slide-id='zoom' data-zoom-id='zoom2' class='active' data-image="+ imgDetMini +"><img width='66' height='70' src="+ imgDetMini +" class=ZoomIMG2 alt=\""+ fn.getNameProduct() +"\" "+ sLazy +"></a></div>";
          }
        }
        ...
        for(var i=0;i<=FC_MaxImages;i++)
        {
          if(i===0)
          {
            ...
            sHtmlZoom+="<div class='selectors'><span class='multiple-thumbnails'><a href="+imgAmpMini+" data-slide-id='zoom' data-zoom-id='zoom2' class='active what' data-image="+ imgDetMini +"><img width='66' height='70' src="+ imgDetMini +" class=ZoomIMG2 alt=\""+ fn.getNameProduct() +"\""+ sLazy +"></a></span></div>";
          }
        }
      }            
  ...
  function fnResetOptions(objElementParent){
    ...
    if(iNivelAtual==(aDestinosDescritores.length-1)){
      ...
      var titleDescritor1Sel=document.getElementById('idNivelGridFC_0_select_1');
      if(titleDescritor2Sel) titleDescritor2Sel.previousSibling.innerText=rk('grid-choose-options-text')+": ";
      else if(titleDescritor1Sel) titleDescritor1Sel.previousSibling.innerText=rk('grid-choose-options-text')+": ";
