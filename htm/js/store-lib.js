...
var sF$=(function(){
  ...
  function fnShowProd0(Price,OriginalPrice,Cod,iMaxParcels,ProductID){
    ...
    if(Price!=OriginalPrice){
      ...
      if(iMaxParcels>1)sPrice+="  <div class=\"installments font-regular\"><strong>"+ iMaxParcels +"x</strong> <strong><span class=\"installment-price\">"+ FCLib$.formatMoney(CalculateInstallment(Price,iMaxParcels),FC$.Currency) +"</span></strong>"+ sInterest +"</div>";
      sPrice+="</div>";
    }
    else{
      sPrice+="<div class=\"prices\">";
    ...
    if(aImgsShare)
      for(var i=0;i<aImgsShare.length;i++){
        ...
        if(aImgsShare[i].className=='EstImgShareFacebook'){
          aImgsShare[i].setAttribute(sSrc,FC$.PathImg +'iconprodfacebook.svg?cccfc=1');
          ...
          aImgsShare[i].setAttribute(sSrc,FC$.PathImg +'iconprodtwitter.svg?cccfc=1');
          ...
          aImgsShare[i].setAttribute(sSrc,FC$.PathImg +'iconprodpinterest.svg?cccfc=1');
    ...
    if(fnGetConfig("History_Page")){
      ...
      if(oPageHistory){
        ...
        for (i=0;i<oHistoryPages.length;i++){
          ...
          /*sPageHistory+="<li>";
          sPageHistory+="<div class='EstImagePageHistory'><a href='"+ sLinkProd +"'><img width='132' height='132' "+ sSrc +"='"+ sImageProd +"' alt='"+ sTitleProd +"' border=0 class=EstFotoPageHistory onError=MostraImgOnError(this,0)"+ sLazy +"></a></div>";
          ...
          sPageHistory+="<div class='EstImagePageHistory'><img width='132' height='132' "+ sSrc +"='"+ sImageProd +"' alt='"+ sTitleProd +" - Product' title='"+ sTitleProd +"' border=0 class=EstFotoPageHistory onError=MostraImgOnError(this,0)"+ sLazy +"></div>";
  ...
  function fnLoginUserName(NameUser,PicUser){
    ...
    if(NameUser==""){
      document.getElementById('fc-loginInfo').innerHTML = "<a href='"+ FCLib$.uk("url-register") +"?pp=3&passo=1&sit=1'><img src="+ FC$.PathImg +"iconuser.svg width=30 height=30"+ sLazy +" alt='Login user'></a>";
  ...
  function fnSlideshowSwiper(){
    var swiper = new Swiper('.swiper-container', {
      ...
      autoplay: {
       delay: fnGetConfig("Time_Slideshow"),
      },
    });
  }
    ...
    if(fnGetConfig("Change_Image_Hover_Home_ProductList")){   
      if (tagImgPri==""){
        ...
        if(nLenghtImg<0){
          ...
          document.getElementById(sIdCampo).innerHTML="<a href="+ sDescUrl +"><img height='159'"+ sSrcLocal +"='"+ sImagemProdPri +"' alt=\""+ countNameProduct +"\""+ sLazy +"></a>";
        }
        else {
          var valImgDet=null;
          ...
          if(imgDet0==null){
            ...
            document.getElementById(sIdCampo).innerHTML="<a href=" + sDescUrl + "><img height='159' "+ sSrcLocal +"='" + imgDet0 + "' border=0 onmouseover=\"this.src='" + imgDet1 + "'\"  onfocus=\"this.src='" + imgDet1 + "'\"  onmouseout=\"this.src='" + imgDet0 + "'\"   onblur=\"this.src='" + imgDet0 + "'\"  alt=\""+ countNameProduct +"\""+ sLazy +"  tabIndex='0'></a>";
          }
        }
      }
  ...
  function fnAriaLabelInclude(){
    ...
    var poweredByAltIMG = document.getElementById("idBadgeFC").getElementsByTagName('img')[0].setAttribute("alt", "Powered by Fastcommerce");
  }
  ...
  function fnRemoveSpy2From(varElement,varNewLink,idElement,urlProdTag){
    ...
    if(varElement){
      ...
      varNewLink.href=urlProdTag;
      varElement.removeAttribute('onclick');
      varElement.parentNode.insertBefore(varNewLink,varElement);
      varNewLink.appendChild(varElement);
    }
  }
  ...
  function fnProd0(prodImgMain,prodImgDet,URLProd,prodId,prodNameFU,prodPriceNum,prodPriceOri,prodRef,prodMaxInstallmentNum,prodStock){
  ...
  FCLib$.onReady(function(){
    ...
    if(FC$.Page=="Products"){
      if(iQtdProds>2){
        ...
        oScript.async=true;
        oScript.src=FC$.PathHtm+'js/sort-lib.js?cccfc=11';
